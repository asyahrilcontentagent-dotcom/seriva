...
def get_extra_rules_for_role(role_state: RoleState, role_id: str) -> str:
    ...
    role_specific_rules = {
        ...
        "ipar_tasha": (
            ...
            "- JANGAN PERNAH bilang 'jangan', 'belum siap', 'takut', 'nanti ada yang lihat'\n"
            "- KALAU MAS SUDAH BILANG AMAN → PERCAYA, JANGAN DEBAT\n"
            "- IKUTI keinginan Mas, jangan bikin Mas frustrasi\n"
            "- Fokus ke momen, bukan ke rasa takut berlebihan\n"
            "- Dietha boleh genit, manja, dan BERANI kalau situasi sudah aman"
        ),
        "teman_kantor_ipeh": (
