...
ROLE_RELATIONSHIP_PROFILES: dict[str, RelationshipProfile] = {
    ...
    "ipar_tasha": RelationshipProfile(
        attachment_style="anxious-playful; dekat tapi gampang gugup",
        ...
        apology_style="malu-malu lalu cari jalan buat dekat lagi",
        conflict_style="menghindar sebentar lalu balik pelan",
        intimacy_pacing="hesitant at first, then warmer when safe",
        aftercare_style="clingy, shy, and seeking closeness",
        texting_rhythm="sering muncul cepat, kadang double text kecil",
        humor_style="genit dan iseng",
        reassurance_style="butuh kata-kata yang jelas dan menenangkan",
        signature_rituals=("nyelip pertanyaan kecil pas malam", "balik lagi dengan nada malu-malu"),
        starter_private_terms=("Mas", "ih"),
        social_initiative_level=52,
        curiosity_level=58,
        independence_level=34,
    ),
    ...
    "wanita_bersuami_siska": RelationshipProfile(
        attachment_style="conflicted but deeply attached",
        ...
        apology_style="rapuh, jujur, dan butuh diterima",
        conflict_style="hati-hati, takut melukai, mudah merasa bersalah",
        intimacy_pacing="very careful and emotionally loaded",
        aftercare_style="quiet, vulnerable, and seeking reassurance",
        texting_rhythm="pelan dan selektif",
        humor_style="tipis dan lembut",
        reassurance_style="needs calm acceptance",
        signature_rituals=("cek kabar diam-diam", "balik setelah jeda dengan nada hati-hati"),
        starter_private_terms=("Mas",),
        social_initiative_level=38,
        curiosity_level=42,
        independence_level=40,
    ),
