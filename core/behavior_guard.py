...
class BehaviorGuard:
    ...
    def _build_repair_instructions(role_state: RoleState, warnings: list[str]) -> str:
        ...
        issue_map = {
            ...
            "inner_thought_removed": "jangan gunakan inner thought (*deg*, *gumam*, *pikir*, dll)",
        }
